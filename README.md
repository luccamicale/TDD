...
**TDD project** In this project we implemented a class with some methods, and we did it by doing test-driven development (TDD).
...
### Setup
```
- To clone the repository run this command - "https://github.com/luccamicale/TDD.git"
- cd school-library
```
